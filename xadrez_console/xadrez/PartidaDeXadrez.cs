...
namespace xadrez {
    class PartidaDeXadrez {
        ...
        public Peca vulneravelEnPasssant { get; private set; }
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada) {
            ...
            //#jogadaespecial en passant
            if ( p is Peao) {
                if (origem.coluna != destino.coluna && pecaCapturada == vulneravelEnPasssant) {
